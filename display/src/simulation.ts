...
import {height, width, dataLoader} from "./config";
...
const forceLink = d3.forceLink(dataLoader.getFilteredEdges())
    .id((d: any) => d.id)
    .distance(150)
    .strength(0.7);
...
const filteredNodes: any = dataLoader.getFilteredNodes();
export const simulation = d3.forceSimulation(filteredNodes)
